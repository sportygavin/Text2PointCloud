"""
Text2PointCloud - Web Interface

A Flask web application for text-to-point-cloud generation.
"""
...
class Text2PointCloudWebApp:
    """
    Web application for text-to-point-cloud generation.
    """
    ...
    def create_plotly_figure(self, points, text, validation_results):
        ...
        # Update layout
        fig.update_layout(
            title=f"Generated Point Cloud: '{text}'",
            scene=dict(
                xaxis_title='X',
                yaxis_title='Y',
                zaxis_title='Z',
...
<head>
    ...
    <title>Text2PointCloud - Generate 3D Point Clouds from Text</title>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Generate 3D Point Clouds from Text Descriptions</p>
        </div>
        ...
        <div class="content">
            <div class="input-section">
                <div class="input-group">
                    ...
                    <input type="text" id="textInput" placeholder="e.g., a wooden chair with four legs" value="a comfortable wooden dining chair">
                </div>
                ...
                <div class="button-group">
                    <button onclick="generatePointCloud()">Generate Point Cloud</button>
                    <button onclick="clearResults()">Clear</button>
                </div>
                
                <div class="loading" id="loading">
                    <p>🔄 Generating point cloud... Please wait...</p>
                </div>
            </div>
